...
<head>
    ...
    <link rel="stylesheet" href="css/links.css" /> <!-- <link rel="stylesheet" href="css/formdesign.css" /> -->
        ...
        <article>
            ...
            <form action="mostrarlibros.php?id=<?php echo $_GET['id'] ?>" method="POST" class="formoid- solid-purple">
                ...
                <div class="element-name">
                    <label class="title"></label>
                    <div class="nameFirst"> <input type="text" name="autor" value="<?php echo $row['autor'] ?>" maxlength="50" placeholder="Autor" class="large" />
                        <span class="icon-place"></span>
                    </div>
                </div>
                ...
                <div class="element-number">
                    <label class="title"></label>
                    <div class="item-cont"> <input type="text" name="precio" value="<?php echo $row['precio'] ?>" maxlength="8" placeholder="Precio" class="large" /> <span class="icon-place"></span> </div>
                </div>
